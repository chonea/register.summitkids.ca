...
define("DB_HOST", "mysql51-076.wc2.dfw1.stabletransit.com");
define("DB_NAME", "789039_summitreg");
define("DB_USER", "789039_summitreg");
define("DB_PASS", "r3g@Summ1t!");
 */
 ...
 */
define("COOKIE_RUNTIME", 1209600);
define("COOKIE_DOMAIN", ".register.summitkids.ca");
define("COOKIE_SECRET_KEY", "09jf32F@#)if432890j");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://register.summitkids.ca/login/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@summitkids.ca");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Summit Kids Registration");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Summit Kids Registration");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click on this link to reset your password:");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://register.summitkids.ca/login/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@summitkids.ca");
define("EMAIL_VERIFICATION_FROM_NAME", "Summit Kids Registration");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Summit Kids Registration");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account:");

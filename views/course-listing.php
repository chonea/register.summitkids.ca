...
if (isset($_REQUEST['range'])) {
	if ($_REQUEST['range'] == 'current' || $_REQUEST['range'] == '') {
		$range_str = "Current";
...
<?php
	...
	foreach ($courses as $course) {
		...
		if ($new_order_1 != $current_order_1 || $new_order_2 != $current_order_2) {
			...
			echo '<div class="application-column span2">Start</div>';
			echo '<div class="application-column span2">End</div>';
			echo '<div class="application-column span2">Registration Start</div>';
			echo '<div class="application-column span2">Registration End</div>';

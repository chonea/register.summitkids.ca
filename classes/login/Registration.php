...
class Registration
{
    ...
    public function __construct()
    {
        ...
        if (isset($_POST["register"])) {
            // $this->registerNewUser($_POST['user_name'], $_POST['user_email'], $_POST['user_password_new'], $_POST['user_password_repeat'], $_POST["captcha"]);
						// Updated by CH @ Vertical Motion
            $this->registerNewUser($_POST['user_first_name'], $_POST['user_last_name'], $_POST['user_email'], $_POST['user_email'], $_POST['user_password_new'], $_POST['user_password_repeat'], $_POST["captcha"]);
     ...
     * everything is fine
     */
    private function registerNewUser($user_first_name, $user_last_name, $user_name, $user_email, $user_password, $user_password_repeat, $captcha)
    {
        ...
        // finally if all the above checks are ok
            ...
            if (count($result) > 0) {
                ...
                $query_new_user_insert = $this->db_connection->prepare('INSERT INTO users (user_name, user_password_hash, user_email, user_first_name, user_last_name, user_activation_hash, user_registration_ip, user_registration_datetime) VALUES(:user_name, :user_password_hash, :user_email, :user_first_name, :user_last_name, :user_activation_hash, :user_registration_ip, now())');
